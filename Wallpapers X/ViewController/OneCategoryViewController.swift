...
class OneCategoryViewController: UIViewController {
    ...
    let segueToFull = "segueOneToFull"
    let reuseIdentifier = "OneCVCell"
    ...
    override func viewDidLoad() {
        ...
        Analytics.setScreenName("OneCategoryView", screenClass: "OneCategoryViewController")
...
extension OneCategoryViewController: UICollectionViewDelegate,
...
extension OneCategoryViewController {
    ...
    func loadWallsFromFirebase() {
        ...
        let query = refWallX.child("wallpaper").queryOrdered(byChild:"category").queryEqual(toValue: categoryName)
